...
* add timeout for task function ([#1234](https://github.com/apify/crawlee/issues/1234)) ([33df439](https://github.com/apify/crawlee/commit/33df4391f2f9b12c238f796f942e28062244f08d))
* add timeouts with retries to `runTaskFunction()` ([#1250](https://github.com/apify/crawlee/issues/1250)) ([a271862](https://github.com/apify/crawlee/commit/a2718628cc191bd6a017367034e6b87487ae4f1d))
* add ts-ignore comments to imports of optional peer dependencies ([#1152](https://github.com/apify/crawlee/issues/1152)) ([bb9ad87](https://github.com/apify/crawlee/commit/bb9ad87471f3f65616c23f4648f57889d14910de))
...
* allow passing `requestsFromUrl` to `RequestListOptions` in TS ([c0ae5bd](https://github.com/apify/crawlee/commit/c0ae5bd9d300a81ccd2717da1992c804a05394ac)), closes [#1191](https://github.com/apify/crawlee/issues/1191)
...
* automatically convert gdoc share urls to csv download ones in req. list ([#1174](https://github.com/apify/crawlee/issues/1174)) ([ad79fee](https://github.com/apify/crawlee/commit/ad79fee490ef5276c44fce4e2a7511b7d51959ac)), closes [#639](https://github.com/apify/crawlee/issues/639)
* automatically convert google spreadsheet URLs to CSV exports ([#1255](https://github.com/apify/crawlee/issues/1255)) ([1c5ed76](https://github.com/apify/crawlee/commit/1c5ed7665da138703d762f49ce7e283a2a2066a1))
...
* broken session pool ([#970](https://github.com/apify/crawlee/issues/970)) ([088959f](https://github.com/apify/crawlee/commit/088959fed7454ddeb9c0472fd6fd3338bfcf0112))
...
* bump `got-scraping` to `3.0.1` ([#1121](https://github.com/apify/crawlee/issues/1121)) ([b9e99b7](https://github.com/apify/crawlee/commit/b9e99b7013654cef9feca33d54ebe6a82b73077e))
...
* casting of int/bool environment variables (e.g. `APIFY_LOCAL_STORAGE_ENABLE_WAL_MODE`) ([#1146](https://github.com/apify/crawlee/issues/1146)) ([090bbbe](https://github.com/apify/crawlee/commit/090bbbee7986872c79b9e22ffcfa4b8a54b5dcc2)), closes [#956](https://github.com/apify/crawlee/issues/956)
* catch errors inside request interceptors ([#1192](https://github.com/apify/crawlee/issues/1192)) ([69a5a33](https://github.com/apify/crawlee/commit/69a5a33ed57bef7058778c74ce24b3ac6b549093))
* change github user ([ceae1a5](https://github.com/apify/crawlee/commit/ceae1a5c317b1848d2c9e31340503fdef872792c))
* cheerio issues with HTML serialization ([#1113](https://github.com/apify/crawlee/issues/1113)) ([e0ae762](https://github.com/apify/crawlee/commit/e0ae762a7e40b278a97a8c1fbb1196efe8e76be5))
...
* configuration apiBaseUrl ([#1095](https://github.com/apify/crawlee/issues/1095)) ([60d4086](https://github.com/apify/crawlee/commit/60d408642162065ba646bdac61f65731fb49af36))
...
* cookies setting in preNavigationHooks ([#1283](https://github.com/apify/crawlee/issues/1283)) ([178d6e3](https://github.com/apify/crawlee/commit/178d6e311b4c2572d03e015f13bface4fb5fc033))
...
* deprecation messages in `CheerioCrawler` and `ProxyConfiguration` ([#1129](https://github.com/apify/crawlee/issues/1129)) ([7b7a971](https://github.com/apify/crawlee/commit/7b7a9711ed89eae5b73132df1e7730fcc991086f))
...
* do not use `tryCancel()` from inside sync callback ([#1265](https://github.com/apify/crawlee/issues/1265)) ([6f951f1](https://github.com/apify/crawlee/commit/6f951f14a47fe5ab007137ec54e94ce16a4dbc19))
...
* ensure `request.headers` is set ([#1281](https://github.com/apify/crawlee/issues/1281)) ([966292b](https://github.com/apify/crawlee/commit/966292b5e5de7e9e9210c47bc2f1c9bc407da416))
...
* ensure failed req count is correct when using `RequestList` ([#1347](https://github.com/apify/crawlee/issues/1347)) ([8090509](https://github.com/apify/crawlee/commit/80905094ad2892ad61f79c5acb4aace79afbdff4))
...
* error when Apify.call does not return OUTPUT ([#999](https://github.com/apify/crawlee/issues/999)) ([9357205](https://github.com/apify/crawlee/commit/935720567985a5e01a6f4d501f21eec2497b0354))
...
* expose logger classes on the `utils.log` instance ([#1278](https://github.com/apify/crawlee/issues/1278)) ([e622e6b](https://github.com/apify/crawlee/commit/e622e6b62ca849d7daddf3439f4dec30d0e74525))
...
* fix `YOUTUBE_REGEX_STRING` being too greedy ([#1171](https://github.com/apify/crawlee/issues/1171)) ([6c21c4a](https://github.com/apify/crawlee/commit/6c21c4a8c39b1ba25e992fc421ed9d9076abc9a4))
...
* fix support for building TypeScript projects ([b1fb020](https://github.com/apify/crawlee/commit/b1fb02015450f7be210dd7b9e2fff74f0431ffc1)), closes [#819](https://github.com/apify/crawlee/issues/819)
...
* flaky Snapshotter test ([660a779](https://github.com/apify/crawlee/commit/660a779432776276ba3d53b886f0303f0cdddef7))
* handle extra cases for diffCookie ([#1217](https://github.com/apify/crawlee/issues/1217)) ([32776bc](https://github.com/apify/crawlee/commit/32776bc813d684769bd956f080c1188ebe1fbe40))
...
* hardcode public API URL in key-value store URL getter ([#1108](https://github.com/apify/crawlee/issues/1108)) ([4e2bd76](https://github.com/apify/crawlee/commit/4e2bd76078b24a579d71f9dd9b6f4bfa449c09e3))
* headerGeneratorOptions not passed to requestAsBrowser ([#1105](https://github.com/apify/crawlee/issues/1105)) ([675da8f](https://github.com/apify/crawlee/commit/675da8fefd5b1b854c80d8719d03c0d8d0d27f09))
...
* ignore requests that are no longer in progress ([#1258](https://github.com/apify/crawlee/issues/1258)) ([ed9c80b](https://github.com/apify/crawlee/commit/ed9c80b9924539fa1007c28a9cf79d30f07c717d))
* implement abortable timeouts ([#1245](https://github.com/apify/crawlee/issues/1245)) ([6488b94](https://github.com/apify/crawlee/commit/6488b9440e8a444db146fe620455ab3985ce2707))
* improve browser launcher types ([#1318](https://github.com/apify/crawlee/issues/1318)) ([f167db9](https://github.com/apify/crawlee/commit/f167db95ab7528044ff019c29cbb6689be6f9b41))
...
* improve error message when no default route provided ([04c3b6a](https://github.com/apify/crawlee/commit/04c3b6ac2fd151379d57e95bde085e2a098d1b76))
...
* improve guessing of chrome executable path on windows ([#1294](https://github.com/apify/crawlee/issues/1294)) ([82abcdf](https://github.com/apify/crawlee/commit/82abcdf576dc7bd666d0823a5e298daaad6e2c6d))
...
* incognito pages and user data dir ([#1145](https://github.com/apify/crawlee/issues/1145)) ([30523a3](https://github.com/apify/crawlee/commit/30523a3374d6d90a56ae4598d45230b32adaf4d8))
* incorrect offset in `fixUrl` function ([#1184](https://github.com/apify/crawlee/issues/1184)) ([bc8c0a4](https://github.com/apify/crawlee/commit/bc8c0a43403731152c21903ea98aabeb3fe49c16))
...
* invalid underscore requires after 1.13 update ([#989](https://github.com/apify/crawlee/issues/989)) ([058af35](https://github.com/apify/crawlee/commit/058af35a83289ec8789929e2d1e8c3840b209e54))
...
* limit `handleRequestTimeoutMillis` to max valid value ([#1116](https://github.com/apify/crawlee/issues/1116)) ([5948958](https://github.com/apify/crawlee/commit/594895835222d1f78218e9798619a417edde731f))
* lock browser-pool version so we do not use latest beta automatically ([604459e](https://github.com/apify/crawlee/commit/604459e9cea3f1d6aa73452447b67ced44bf1310))
...
* merge cookies provided by user with session cookies ([#1201](https://github.com/apify/crawlee/issues/1201)) ([cccea78](https://github.com/apify/crawlee/commit/cccea783a0d233c16c15224a7876376199fffd95))
...
* old image in missing puppeteer warning ([138efec](https://github.com/apify/crawlee/commit/138efec998a650be3a5a6f899da4affbcc0016fe))
* only provide Cookie header if cookies are present ([#1218](https://github.com/apify/crawlee/issues/1218)) ([cfdcbcb](https://github.com/apify/crawlee/commit/cfdcbcb87fc2fdc37250a1f2da1f396d99528a5a))
...
* pin got-scraping to fix compatibility issues ([9cf09fa](https://github.com/apify/crawlee/commit/9cf09faee2234b2057cd44693cd988ccfa997a91))
...
* proxy per page broke session fetching ([#1256](https://github.com/apify/crawlee/issues/1256)) ([b0a5bc0](https://github.com/apify/crawlee/commit/b0a5bc056cffe961b70e1b033822f8a67a091f3e))
* proxyUrl without port throwing on browser launch ([#1065](https://github.com/apify/crawlee/issues/1065)) ([ea10095](https://github.com/apify/crawlee/commit/ea100959dcb9936a36a74bdeeba049de9f40740b))
* prune CPU snapshots locally ([#1313](https://github.com/apify/crawlee/issues/1313)) ([03b4521](https://github.com/apify/crawlee/commit/03b4521a59b16524f3ecc50ba44bd591481c0320))
...
* random puppeteer crawler (running in headful mode) failure ([#1348](https://github.com/apify/crawlee/issues/1348)) ([e2d9233](https://github.com/apify/crawlee/commit/e2d9233687343ea505ef2019f289bd3702a4cee6))
...
* refactor `requestAsBrowser` to Got 12 ([#1111](https://github.com/apify/crawlee/issues/1111)) ([ef9a4ad](https://github.com/apify/crawlee/commit/ef9a4ad32701f6613aea0a6104c68824687fe93a)), closes [#1114](https://github.com/apify/crawlee/issues/1114)
* regression in resolving the base url for enqueue link filtering ([#1422](https://github.com/apify/crawlee/issues/1422)) ([8a00cf6](https://github.com/apify/crawlee/commit/8a00cf6f35ada5dd83b110793b75fac07c57631e))
...
* requestAsBrowser legacy options json/payload ([#1029](https://github.com/apify/crawlee/issues/1029)) ([3cedd4d](https://github.com/apify/crawlee/commit/3cedd4de61016f636fba7bec6198ee560df6f8bb)), closes [#1028](https://github.com/apify/crawlee/issues/1028)
...
* reset `RequestQueue` state after 5 minutes of inactivity ([#1324](https://github.com/apify/crawlee/issues/1324)) ([fc6e4bf](https://github.com/apify/crawlee/commit/fc6e4bf7566a8541c3b9968623d325bdf00f9bd6))
...
* revert to puppeteer 10.x ([#1276](https://github.com/apify/crawlee/issues/1276)) ([b5e6220](https://github.com/apify/crawlee/commit/b5e62204f6cf923da5af76b876e3082a1a86ac06))
...
* run browser crawlers in headless mode by default ([#1409](https://github.com/apify/crawlee/issues/1409)) ([b207c12](https://github.com/apify/crawlee/commit/b207c12b120d4083acb752f688278958bbcf62bf))
* sendRequest types ([#1445](https://github.com/apify/crawlee/issues/1445)) ([751563b](https://github.com/apify/crawlee/commit/751563b4f692e91e64303ecee793ff131b2f835b))
...
* SessionPoolOptions not working in BrowserCrawler ([4a79b0c](https://github.com/apify/crawlee/commit/4a79b0cb38ed4c966d7c863873ac4f88776e28d4))
...
* update utils.enqueueLinks to ignore invalid URLs when using cheerio ([#1369](https://github.com/apify/crawlee/issues/1369)) ([953fb66](https://github.com/apify/crawlee/commit/953fb66c07b6df31baebd31fcf765b7635f50240))
* update utils.purgeLocalStorage to mimic 'purge' param of 'apify run' ([#1355](https://github.com/apify/crawlee/issues/1355)) ([b9b77cc](https://github.com/apify/crawlee/commit/b9b77ccf94aa62a7e439e0c711f5318aceac1ed5))
...
* use config instance in `sdk.openSessionPool()` ([#1154](https://github.com/apify/crawlee/issues/1154)) ([664bdc9](https://github.com/apify/crawlee/commit/664bdc9a1f6514388c7ec09e6c97017ff85e678d))
* use correct apify-client instance for snapshotting ([#1308](https://github.com/apify/crawlee/issues/1308)) ([91d152a](https://github.com/apify/crawlee/commit/91d152a295c0822aed598e25efefb87f4cb27541)), closes [#1306](https://github.com/apify/crawlee/issues/1306)
* use default user agent for playwright with chrome ([#1350](https://github.com/apify/crawlee/issues/1350)) ([d2d5ac7](https://github.com/apify/crawlee/commit/d2d5ac7476e4ddf5f5398ca24e8ca64d9a364b21))
* use encodeURIComponent instead of encodeURI ([#1198](https://github.com/apify/crawlee/issues/1198)) ([cd98da0](https://github.com/apify/crawlee/commit/cd98da0dce1763a41676922a38082df1b1ed83f3))
...
* utils.apifyClient early instantiation ([#1330](https://github.com/apify/crawlee/issues/1330)) ([077c31d](https://github.com/apify/crawlee/commit/077c31d6f5bfd51eebbb2271a9e9544e33fd956b))
...
* wait when `body` is not available in `infiniteScroll()` from Puppeteer utils ([#1277](https://github.com/apify/crawlee/issues/1277)) ([57987cd](https://github.com/apify/crawlee/commit/57987cde042915c972cfe0853946f11f6ae07a3f))
* workaround for decodeURI ([#1206](https://github.com/apify/crawlee/issues/1206)) ([e248fb2](https://github.com/apify/crawlee/commit/e248fb2490a9c91a74fdb07a5a490306915dd490))
...
* accept more social media patterns ([#1286](https://github.com/apify/crawlee/issues/1286)) ([d1fdf65](https://github.com/apify/crawlee/commit/d1fdf65974a4d8da0f6354291fb22ead25b97841))
...
* add `forceUrlEncoding` option to `requestAsBrowser` ([#1086](https://github.com/apify/crawlee/issues/1086)) ([442a7ac](https://github.com/apify/crawlee/commit/442a7ac7dbd5c8bb12eb9f6bc2d85470d7218ffc)), closes [#679](https://github.com/apify/crawlee/issues/679) [#658](https://github.com/apify/crawlee/issues/658)
...
* add `keepAlive` to crawler options ([#1452](https://github.com/apify/crawlee/issues/1452)) ([084b6b2](https://github.com/apify/crawlee/commit/084b6b2e782ceae466e5c8f59924278535450ab9))
* add `keyValueStore` option to `Statistics` class ([#1345](https://github.com/apify/crawlee/issues/1345)) ([898cc43](https://github.com/apify/crawlee/commit/898cc43fc66d951ed05911d266640ae8bf68c221)), closes [#1344](https://github.com/apify/crawlee/issues/1344)
...
* add `playwright.utils.injectJQuery` ([#1337](https://github.com/apify/crawlee/issues/1337)) ([133de35](https://github.com/apify/crawlee/commit/133de356c4b81b42b5923b4f716780769bfde335))
* add `RetryRequestError` + add error to the context for BC ([#1443](https://github.com/apify/crawlee/issues/1443)) ([1a54171](https://github.com/apify/crawlee/commit/1a5417169e1e24a5f1b30b7850150339b8544b6b))
* add `set` and `useStorageClient` shortcut to `Configuration` ([2e66fa2](https://github.com/apify/crawlee/commit/2e66fa2fad84aee2dca08b386916b465a0c012a3))
* add `taskTimeoutSecs` to allow control over timeout of `AutoscaledPool` tasks ([#1082](https://github.com/apify/crawlee/issues/1082)) ([ff6eb3f](https://github.com/apify/crawlee/commit/ff6eb3f86d0ccbf0f8ab7ec13164beed8b367583))
...
* add a breaking callback to `infiniteScroll` ([#1140](https://github.com/apify/crawlee/issues/1140)) ([6bd8411](https://github.com/apify/crawlee/commit/6bd84119e560bc210cd56ef9f3ea38c7cdb912c9))
...
* add fingerprinting support ([#1243](https://github.com/apify/crawlee/issues/1243)) ([bd596de](https://github.com/apify/crawlee/commit/bd596def41405cef6108f32bafed5f000c5f4dfe))
...
* add multiple click ([#1295](https://github.com/apify/crawlee/issues/1295)) ([09eeb28](https://github.com/apify/crawlee/commit/09eeb28b6b05f431372a5331b8d2d9d2c98f5a5e))
...
* add support for middlewares to the `Router` via `use` method ([#1431](https://github.com/apify/crawlee/issues/1431)) ([6fee20d](https://github.com/apify/crawlee/commit/6fee20d8a2a390dd6bf505b50872b2ca2386bb10))
* added docs and handling of aborting event into basic crawler ([#1052](https://github.com/apify/crawlee/issues/1052)) ([9f9e503](https://github.com/apify/crawlee/commit/9f9e503497aff1e215a0358a76e86d7c3581655a))
...
* allow configuring what status codes will cause session retirement ([#1423](https://github.com/apify/crawlee/issues/1423)) ([cd3795f](https://github.com/apify/crawlee/commit/cd3795f8b94dd1504b380fad913aea4e6b410485))
...
* allow passing a stream to `KeyValueStore.setRecord` ([#1325](https://github.com/apify/crawlee/issues/1325)) ([31ebd5c](https://github.com/apify/crawlee/commit/31ebd5c0b69a37e7b752985d1422bc6b5a7d51ad))
...
* bump puppeteer support to up to v13.x ([#1301](https://github.com/apify/crawlee/issues/1301)) ([0511bb6](https://github.com/apify/crawlee/commit/0511bb65ad09571e865d43454e3cc09d44c57422))
...
* **InfiniteScroll:** use puppeteer emulating scrolls instead of window.scrollBy ([#1170](https://github.com/apify/crawlee/issues/1170)) ([a22b8aa](https://github.com/apify/crawlee/commit/a22b8aa772e12c313fc197e5ea95d164287811cb))
...
* instance-scoped "global" configuration ([#1315](https://github.com/apify/crawlee/issues/1315)) ([eab4e7f](https://github.com/apify/crawlee/commit/eab4e7faa123cbd34ed7ca31736b3f2931dcf4a9))
* introduce new `Apify` and `Configuration` classes ([#993](https://github.com/apify/crawlee/issues/993)) ([d44f3b5](https://github.com/apify/crawlee/commit/d44f3b506822467fd0ec518a1436513207cd56c8))
...
* prefer `/INPUT.json` files for `KeyValueStore.getInput()` ([#1453](https://github.com/apify/crawlee/issues/1453)) ([7ea0552](https://github.com/apify/crawlee/commit/7ea05526727f0e0e301ac412eade8cdfc3a9e4fe))
* proxy per page ([#1228](https://github.com/apify/crawlee/issues/1228)) ([2d2118e](https://github.com/apify/crawlee/commit/2d2118e1c3889ba91a8e36f940ff3263d1e50e5e))
...
* requestList accepts proxyConfiguration for `requestsFromUrls` ([#1317](https://github.com/apify/crawlee/issues/1317)) ([c120837](https://github.com/apify/crawlee/commit/c120837e1737aa9fdcfb0c827c3613e93b150982))
...
* **SessionPool:** allow passing `forceCloud` down to the KV store ([#1186](https://github.com/apify/crawlee/issues/1186)) ([b86a4f2](https://github.com/apify/crawlee/commit/b86a4f2b463e5666a763cbabad5f84d7c077b9b6))
...
* stealth deprecation ([#1314](https://github.com/apify/crawlee/issues/1314)) ([7d20ac2](https://github.com/apify/crawlee/commit/7d20ac2aa01b40721579e4f768c031d91b3e10c8))
...
* support async transformRequestFunctions ([023a477](https://github.com/apify/crawlee/commit/023a477668a8256cfbf3fc199436d3705f767afe))
* support channel and user links in YouTube regex ([#1178](https://github.com/apify/crawlee/issues/1178)) ([65f2e91](https://github.com/apify/crawlee/commit/65f2e9150f55c83e675161deb6a056b1054994f0))
...
* use session token with got-scraping ([#1122](https://github.com/apify/crawlee/issues/1122)) ([d3261ca](https://github.com/apify/crawlee/commit/d3261ca53e67cddc8f5520a9cd68244271e9143c))
* **utils:** add `purgeLocalStorage` method ([#1187](https://github.com/apify/crawlee/issues/1187)) ([2ace074](https://github.com/apify/crawlee/commit/2ace074b5c412698117c0d3443aa755262631536))
* warn if apify proxy is used in proxyUrls ([#1173](https://github.com/apify/crawlee/issues/1173)) ([682f8b7](https://github.com/apify/crawlee/commit/682f8b7f27b059e2673f896c0ecf44c6e74576f5))
...
* Revert "fix: make `SessionOptions.sessionPool` required" ([6526e1b](https://github.com/apify/crawlee/commit/6526e1bff3fc679f2a6e5d90d8250458e0481bd1))
* Revert "chore(release): v3.1.0" ([762d345](https://github.com/apify/crawlee/commit/762d345b48f3c308e574541e5737fe7423d55238))
* Revert "chore(deps): update dependency marked to 4.0.10 [security] (#1407)" ([c22da4f](https://github.com/apify/crawlee/commit/c22da4ffd967c059e2f9aa2fb732ba4d36a59035)), closes [#1407](https://github.com/apify/crawlee/issues/1407)
* Revert previous commit ([b2dc808](https://github.com/apify/crawlee/commit/b2dc808bfbe696859a881e10fbbe0155d32c6ca0))
* Revert "RequestList: Persist downloaded requests from requestsFromUrl" ([d88d7ae](https://github.com/apify/crawlee/commit/d88d7ae9532baf15bb9bcd6bb015b2edb7d7ba28))
